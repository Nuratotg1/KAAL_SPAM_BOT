...
Riz_Help = "🔥 𝐊𝐀𝐀𝐋 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 🔥\n\n"
 
Riz_Help += f"__𝐂𝐦𝐝𝐬 𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐢𝐧 𝐊𝐀𝐀𝐋 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓__\n\n"
...
Riz_Help += f"© @KAALNETWORK | @TEAM_KAAL_RIDER\n"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
     await Riz.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴀʟʟ ᴄᴍᴅs", "https://t.me/ITS_HEAVEN_KING")
        ],
        [
